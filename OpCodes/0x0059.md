...
Opcode that handles multiple cases regarding updating an entities data for events.
    ...
    switch (this->EventData[this->ExecPointer + 1])
    {
        case 0:
        {
            if (PTR_EntityMap[this->EntityTargetIndex[1]])
                PTR_EntityMap[this->EntityTargetIndex[1]]->Unknown0000 = FUNC_XiEvent_getworkofs_(this, 2);
