    ...
    switch (code)
    {
        ...
        case 0x0F:
        {
            if (PTR_ActorBuffPtr[this->EntityTargetIndex[1]])
                PTR_ActorBuffPtr[this->EntityTargetIndex[1]]->ModelSize = FUNC_XiEvent_getworkofs_(this, 2) * 0.0099999998;
        ...
        {
            if (PTR_ActorBuffPtr[this->EntityTargetIndex[1]])
                FUNC_XiActor_Unknown(PTR_ActorBuffPtr[this->EntityTargetIndex[1]], FUNC_XiEvent_getworkofs_(this, 2));
