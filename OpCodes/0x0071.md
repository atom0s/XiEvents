...
Notes for the specific cases:
  ...
  * Case `0x40` - _(unknown input)_ Unknown usage at this time. (Seems linkshell related?)
  * Case `0x41` - _(unknown input)_ Unknown usage at this time. (Seems linkshell related?)
